...
public class Atm {
	public static void main(String[] args) {
		...
		User aUser = theBank.addUser("Jatin", "Jain", "2358");
	...
	public static User mainMenuPrompt(Bank theBank, Scanner sc)
	{
		...
		// prompt the user for user for user ID/pin combo until a correct one
		// is reached
		do {
			System.out.printf("\n\nWelcome to the %s\n\n", theBank.getName());
	...
	/**
	 * Show thw transaction history of an account
	...
	public static void withdrawFunds(User theUser, Scanner sc) {
		...
		do {
			System.out.printf("Enter the number (1-%d) of the account\n" +
				"to withdraw: ", theUser.numAccounts() );
			fromAcct = sc.nextInt()-1;
			if(fromAcct < 0 || fromAcct >= theUser.numAccounts()) {
			System.out.println("Invalid account. Please try again. ");
			}
	 ...
	 * @param theUser	the logged-in Used object
	 * @param sc		the Scanner object used for user input
	 */
